// Original GLSL halftone shader demo for WebGL by 
...
uniform sampler2D texture; // The image to reproduce as a halftone
varying vec4 vertTexCoord; 
uniform float density;      // For imperfect, isotropic anti-aliasing in
...
float aastep(float threshold, float value) {
  float afwidth = frequency * (1.0/200.0) / density;
